#
# Module manifest for module 'IsamsBatchApi'
#
...
RootModule = 'Isams.BatchApi.PWSH.dll'
...
GUID = '9416c142-8264-4736-9e1a-1af1ccad5f5e'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ProjectUri = 'https://github.com/CraigChamberlain/IsamsBatchApiClient.NET.Core'
